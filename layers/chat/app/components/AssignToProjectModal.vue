    ...
    <template #body>
      <div class="space-y-2">
        ...
        >
          ...
          />
          <h3 class="mt-2 text-sm font-medium text-[var(--ui-text)]">No projects</h3>
          <p class="mt-1 text-sm text-[var(--ui-text-muted)]">Create a project first to assign chats to it.</p>
        </div>
      </div>
    </template>
